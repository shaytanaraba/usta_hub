...
const styles = StyleSheet.create({
    container: { flex: 1 },
    header: { paddingTop: 0, paddingBottom: 8, paddingHorizontal: 16, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
    ...
    headerLeft: { flex: 1, minWidth: 0, paddingRight: 8 },
    headerIdentity: { flex: 1, minWidth: 0, gap: 6 },
    headerRight: { flexDirection: 'row', gap: 8, flexShrink: 0 },
    userName: { fontSize: 15, fontWeight: '700', flexShrink: 1, lineHeight: 19 },
    ...
    balanceMini: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8, alignSelf: 'flex-start' },
    ...
    accountBrandRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 12 },
    accountBrandLogo: { width: 22, height: 22, borderRadius: 11 },
    accountBrandTitle: { fontSize: 15, fontWeight: '700' },
    ...
    accountHeaderTitleWrap: { flexDirection: 'row', alignItems: 'center', gap: 8 },
    ...
    settingsStatusRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 10, paddingHorizontal: 12, borderRadius: 12, borderWidth: 1 },
    settingsStatusDot: { width: 10, height: 10, borderRadius: 999 },
    settingsStatusValue: { fontSize: 14, fontWeight: '700' },
    ...
    settingsThemeSwitch: { flexDirection: 'row', alignItems: 'center', borderRadius: 12, padding: 4, borderWidth: 1 },
    settingsThemeOption: { flexDirection: 'row', alignItems: 'center', gap: 6, borderRadius: 9, paddingVertical: 6, paddingHorizontal: 10 },
    settingsThemeOptionIcon: { fontSize: 13 },
    settingsThemeOptionText: { fontSize: 12, fontWeight: '700' },
