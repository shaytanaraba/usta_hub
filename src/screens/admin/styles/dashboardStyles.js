...
const styles = StyleSheet.create({
    ...
    peopleRow: {
        flexDirection: 'row',
        justifyContent: 'space-between',
        alignItems: SCREEN_WIDTH < 720 ? 'flex-start' : 'center',
        gap: 12,
        flexWrap: SCREEN_WIDTH < 720 ? 'wrap' : 'nowrap',
    },
    peopleLeft: {
        flexDirection: 'row',
        alignItems: 'center',
        gap: 12,
        flex: 1,
        minWidth: SCREEN_WIDTH < 720 ? '100%' : 240,
    },
    peopleInfo: { flex: 1, minWidth: 0 },
    peopleRight: {
        minWidth: SCREEN_WIDTH < 720 ? '100%' : 280,
        alignItems: SCREEN_WIDTH < 720 ? 'flex-start' : 'flex-end',
        justifyContent: 'center',
        flexShrink: 0,
        marginLeft: SCREEN_WIDTH < 720 ? 0 : 12,
    },
    peopleBadge: {
        alignSelf: SCREEN_WIDTH < 720 ? 'flex-start' : 'stretch',
        marginBottom: 8,
